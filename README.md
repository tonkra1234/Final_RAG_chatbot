...
Retrieval-Augmented Generation (RAG) for chatbots using [LangChain](https://python.langchain.com/docs/get_started/introduction.html) and [Huggingface]([https://python.langchain.com/docs/get_started/introduction.html](https://huggingface.co/)) to retrieve the informations from the documents and [Streamlit]([https://python.langchain.com/docs/get_started/introduction.html](https://streamlit.io/)) to create friendly user interface. The structure and components will be discussed to clearer understand about RAG chatbot.
